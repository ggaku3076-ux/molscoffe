...
export default function Footer() {
  return (
    <footer 
      id="lokasi" 
      className="bg-brand-brown text-white pt-12 md:pt-16 pb-6 md:pb-8 border-t-0"
        ...
        <div className="block md:hidden">
          ...
          <div className="flex flex-col items-center text-center gap-3 mb-8">
            ...
            <p className="text-xs text-white/75 leading-relaxed max-w-[280px]">
              Tempat pelepas penat dan berkolaborasi di Surabaya.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3.5 flex flex-col gap-2">
              ...
              <a href="tel:+628123530547" className="text-[11px] text-white/90 leading-snug">
                0813-3478-3101
              </a>
            </div>
            {/* Email */}
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3.5 flex flex-col gap-2">
              ...
              <a href="mailto:info@molscoffe.vercel.app" className="text-[11px] text-white/90 leading-snug break-all">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 w-full rounded-xl bg-white py-3 text-xs font-bold text-brand-brown hover:bg-white/90 transition-all duration-200 shadow-sm mb-6"
            aria-label="Buka peta Google Maps ke Mols Coffe Surabaya (tab baru)"
          >
            <Compass className="h-4 w-4 text-brand-brown" />
            <span>Petunjuk Arah Google Maps</span>
            <ExternalLink className="h-3 w-3 text-brand-brown" />
          </a>
          ...
          <p className="text-center text-[10px] text-white/50 mt-3">
            © 2026 Mols Coffe Surabaya. All rights reserved.
          </p>
        </div>
        ...
        <div className="hidden md:block">
          ...
          <div className="grid grid-cols-12 gap-8 mb-16 items-start">
            ...
            <div className="col-span-4 flex flex-col gap-4 text-left">
              ...
              <p className="text-sm text-white/80 leading-relaxed mt-2">
                Sebuah tempat pelepas penat, bertukar pikiran, dan berkolaborasi di Surabaya. Kami hadir menyajikan hidangan fusion modern yang dibuat dengan cinta dari dapur kami.
              </p>
            ...
            <div className="col-span-4 flex flex-col gap-4 text-left">
              ...
              <ul className="flex flex-col gap-3 text-sm text-white/90">
                <li className="flex items-start gap-3">
                  ...
                  <span>Jalan Opak No 2 Darmo Kec Wonokromo, Surabaya Jawa timur 60241</span>
                </li>
                <li className="flex items-center gap-3">
                  <Phone className="h-5 w-5 text-white shrink-0" aria-hidden="true" />
                  <a href="tel:+628123530547" className="hover:text-white/80 transition-colors">
                    0813-3478-3101 (WhatsApp)
                  </a>
                </li>
                <li className="flex items-center gap-3">
                  <Mail className="h-5 w-5 text-white shrink-0" aria-hidden="true" />
                  <a href="mailto:info@molscoffe.vercel.app" className="hover:text-white/80 transition-colors">
                    info@molscoffe.vercel.app
                  </a>
                </li>
              </ul>
            ...
            <div className="col-span-4 flex flex-col gap-4 text-left">
              ...
              <div className="flex flex-col gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-2 inline-flex items-center justify-center gap-2 rounded bg-white px-4 py-2.5 text-xs font-bold text-brand-brown hover:bg-white/90 transition-all duration-200 shadow-sm"
                  aria-label="Buka peta Google Maps ke Mols Coffe Surabaya (tab baru)"
                >
                  <Compass className="h-4 w-4 text-brand-brown" />
                  <span>Petunjuk Arah Google Maps</span>
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="text-xs text-white/60">
              Dibuat untuk kebutuhan demo proposal kerja sama Mols Coffe Surabaya.
            </div>
          </div>
        </div>
